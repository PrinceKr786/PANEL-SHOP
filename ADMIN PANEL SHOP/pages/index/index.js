...
r && n && r.addEventListener("click", () => {
    ...
    try {
        ...
        a.checked ? (localStorage.setItem("nexus_admin_id", r), localStorage.setItem("nexus_admin_pass", c)) : (localStorage.removeItem("nexus_admin_id"), localStorage.removeItem("nexus_admin_pass")), localStorage.removeItem("nexus_admin_key"), l(s, "ACCESS_GRANTED"), i.className = "fas fa-check btn-icon", i.style.color = "#00ff66", d("WELCOME COMMANDER", "success"), setTimeout(() => {
